    ...
    def get(self, request, token, *args, **kwargs):
        try:
            ...
            if timezone.now() - login_token.created_at > expiration_limit:
                ...
                login_token.delete()
                return render(request, 'users/login_failed.html', {'message': 'このログインリンクは有効期限が切れています。'})
            # --- ▲▲▲ ここまで ▲▲▲ ---

        except LoginToken.DoesNotExist:
            return render(request, 'users/login_failed.html', {'message': '無効なリンクです。'})
